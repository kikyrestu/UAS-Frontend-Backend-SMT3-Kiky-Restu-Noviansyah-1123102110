...
def init_db():
    ...
    c.execute('''CREATE TABLE IF NOT EXISTS bookings
                 (id INTEGER PRIMARY KEY AUTOINCREMENT,
                  ...
                  payment_method TEXT DEFAULT 'ewallet',
    ...
    # Migration: Add ewallet_balance to users if not exists
    try:
        c.execute("ALTER TABLE users ADD COLUMN ewallet_balance INTEGER DEFAULT 500000")
    except sqlite3.OperationalError:
        pass
